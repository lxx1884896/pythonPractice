...
def chinese_to_pinyin(x):
    ...
    """"例如，一飞冲天变换后为   YI1 FEI1 CHONG1 TIAN1 """
    y = ''
    dic = {}
    with open("unicode_pinyin.txt",encoding='utf-8') as f:
...
def idiom_select(x, mode, opt):
    ...
    if x == None:
        ...
        with open('idiom.txt','r',encoding='utf-8') as f:
            ...
            #下面六行的意思是说，如果这个字的首字母不是Z，就将匹配的范围缩小到以该字母开头的所有词中
            #如果这个字的首字母是Z，那么也同样是这样，将范围缩小到以Z开头的词中
